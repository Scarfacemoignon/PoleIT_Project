...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="../css/new-article2.css">
    ...
    <div class="container-new-article">
        ...
        <form action="Action/newarticleAction.php" method="post" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <textarea id="content" name="content" placeholder="Contenu de l'article" minlength="20" maxlength="10000" required></textarea>
            </div>
            <div class="form-group">
